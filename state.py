...
class WordLadderState(AbstractState):
    ...
    def __lt__(self, other):
    # Here, dist_from_start is g-value and self.h is the heuristic (h-value)
    ...
    def get_neighbors(self):
        ...
        for di, dj in directions:
            ...
            if 0 <= ni < 3 and 0 <= nj < 3:
                ...
                nbr_states.append(EightPuzzleState(new_state, self.goal, self.dist_from_start + 1, self.use_heuristic, (ni, nj)))
        return nbr_states
    ...
    def compute_heuristic(self):
        ...
        for row in range(3):
            for col in range(3):
                ...
                if tile != 0:  # ignoring the empty space
                    goal_row, goal_col = divmod(tile, 3)  # e.g., 5/3 = 1, 5%3 = 2 => position (1,2)
